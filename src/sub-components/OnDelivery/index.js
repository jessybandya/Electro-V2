...
console.log("My ID: ", authId)
  const handleClickOpen = () => {
    if(!homeAddress){
      toast.error("Kindly select address!")
    }else if(!(cartCtx?.items?.length > 0)){
         toast.error("You cannot proceed with an empty cart!")
    }else{
      swal(`Kindly recheck on date & time of delivery: ${selectedDate}`)
      setOpen(true);
    }
  };
                      ...
                      <div className="gold-members p-4">
                        <div className="media">
                          ...
                          <div className="media-body">
                            <h6 className="mb-1 text-secondary">Address to deliver</h6>
                            <p>{!homeAddress ?(<>No location address has been added</>):(
                              <>{homeAddress}</>
                            )}
                            </p>
                            <p className="mb-0 text-black font-weight-bold"><a style={{color:'#fff'}} className="btn btn-sm btn-primary mr-2" onClick={handleShow}>CHOOSE ADDRESS</a>
                            </p>
        ...
        <div className="row">
          <div className="col-md-8">
            <div className="offer-dedicated-body-left">
              ...
              <div className="pt-2" />
              <div className="bg-white rounded shadow-sm p-4 mb-4">
                <h4 className="mb-1">Your Items Info</h4>
               <SummuryOrder />
              </div>
